<template id="user-login-popup-modal">
    <div class="user-login-wrapper">
        ...
        <div class="ul-left-panel rel">
            <div class="panel-wrapper">
                ...
                <form id="validate-guest-postcode-form" class="validate w-100">
                    <div class="form-group">
                        <input id="guest-signup-postcode" type="text" class="ul-input-postcode" placeholder="Enter your postcode (e.g. CB2 VEG)" required data-error="Your postcode is required.">
                    </div>
                    <button type="button" class="ul-btn" onclick="guest_postcode_delivery_modal()">Enter Postcode</button>
                </form>
            </div>
        </div>
        ...
        <div class="ul-right-panel">
            <form method="post" class="form validate ajax-submit" action="<?php echo remote_endpoint('customer-login') ?>">
                ...
                <div class="ul-btn-container">
                    <button type="submit" class="ul-btn">  <i class="fa-solid fa-arrow-right-to-bracket" style="margin-right: 4px; font-size: 18px;"></i>  Sign In </button>
                </div>
            </form>
