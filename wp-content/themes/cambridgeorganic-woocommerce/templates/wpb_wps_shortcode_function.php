...
if( !function_exists( 'wpb_wps_shortcode__function' ) ):

    function wpb_wps_shortcode__function( $atts ){
        ...
        if ( $loop->have_posts() ) {
            ...
            <div class="wpb_slider_area wpb_fix_cart">
                ...
                <div class="wpb-woo-products-slider camb-woo-products-slider owl-carousel owl-theme <?php echo esc_attr( implode(' ', $classes) )?>" <?php wpb_wps_data_attributes( $slider_data_attr ); ?> style="--text-color: <?php echo $atts['text_color'] ?? ''; ?>; --btn-text-color: <?php echo $atts['btn_text_color'] ?? ''; ?>; --btn-bg-color: <?php echo $atts['btn_bg_color'] ?? ''; ?>; ">

                    <?php
                    while ( $loop->have_posts() ) : $loop->the_post();
                        $product = wc_get_product( get_the_ID() );
                        $prod_weight = get_field('product_weight');
                        $is_organic = get_field('is_organic');
                        ?>
                            ...
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    <div class="item-meta-info">
                                        <?php if(!empty($prod_weight)) { ?>
                                        <span><?php echo $prod_weight ?></span>
                                        <?php } ?>
                                        <?php
                                        $label = $is_organic === 'yes' ? 'Organic' : ($is_organic === 'no' ? 'Not Organic' : '');
                                        if ($label) echo "<span>{$label}</span>";
                                        ?>
                                    </div>
